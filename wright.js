...
WRIGHT
This platform is a folder structure created for web designers and developers who work with languages like HTML, CSS, JS, PHP, and their libraries and frameworks in the field of development and programming. And itâ€™s designed so that thereâ€™s no need to spend time on naming and creating a structure for folders, preventing developers and programmers from getting confused during the naming and folder organization process.
...
Second point: If you want to use libraries and frameworks, I suggest creating a folder within each languageâ€™s folder according to your needs and placing the related files there.
...
if(!fs.existsSync(WRIGHT)){
    ...
    if(!fs.existsSync(dashboardFolder)){
        ...
        console.log('A folder(WRIGHT/dashboard) with the same name exists, try again.');
    }
